...
Contents  
[Why does this programme exist?	2](#why-does-this-programme-exist?)

[Who should apply	3](#who-should-apply)

[Selection Process	3](#selection-process)

[Step 1: Submit two AI-assisted projects (submission cutoff date: 15 May 2026\)	4](#step-1:-submit-two-ai-assisted-projects-\(submission-cutoff-date:-15-may-2026\))

[Step 2: Presentation Interview (latest by 18 May 2026\)	6](#step-2:-presentation-interview-\(latest-by-18-may-2026\))

[Step 3: Training and Shadowing (TBC)	6](#step-3:-training-and-shadowing-\(tbc\))

[Important Expectations	7](#important-expectations)
...
| \# Project Title \#\# Overview \#\#\# Problem \- Who is affected?  \- What is the issue? \#\#\# Outcome \- What was achieved?  \- Measurable results (if any). \--- \#\# Demo \- How does the solution work from the user’s perspective, covering the main steps from start to finish?  \- Provide screenshots, GIFs or demo video. \--- \#\# Technology Stack  \#\#\# Frontend components: \- List of client-side technologies used for user interaction. \#\#\# Backend components: \- List of server-side technologies used for processing, APIs, and coordination. \--- \#\# Development Approach with AI \-  List of AI tools, services, models, and their purposes. \-  List of AI agents, including roles and skills. \-  List of key prompts used. \-  List of key review points and the corresponding decision made. \--- \#\# Installation Steps to run the project. \--- \#\# Usage How to use the project (commands, examples, expected behaviour). \--- \#\# Project Structure Explanation of key folders \--- \#\# Reflection \- What worked, what failed, changes made, rationale.  |
| :---- |
...
[42 x SA | AI Taskforce application – Fill out form](https://forms.cloud.microsoft/Pages/ResponsePage.aspx?id=drd2NJDpck-5UGJImDFiPYx43-3KcoRPgkIKYMzPp2NUMTdKSUtGOU9OR003NkpZWEk3QTJYTEVOSy4u)